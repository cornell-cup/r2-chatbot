...
def create_custom_class(words, name, custom_class_id):
    ...
    """
    class_items = list(
        map(lambda word: CustomClass.ClassItem(value=word), words))
